...
#N8N
ENV N8N_WEBHOOK_CONFIRMATION_DEMANDE=${N8N_WEBHOOK_CONFIRMATION_DEMANDE}
ENV N8N_WEBHOOK_VERIFY_SIRET=${N8N_WEBHOOK_VERIFY_SIRET}
ENV N8N_WEBHOOK_NOTIFY_PARTNER=${N8N_WEBHOOK_NOTIFY_PARTNER}
ENV N8N_WEBHOOK_RESET_PASSWORD=${N8N_WEBHOOK_RESET_PASSWORD}
